...
THREE.Geometry.prototype = {
  ...
  computeNormals: function (m) {
    var e, b, o, g, i, j, l, k, d, c, a, h = new THREE.Vector3(),
      p = new THREE.Vector3();
...
THREE.WebGLRenderer = function () {
  ...
  this.createBuffers = function (F, D) {
    var B, t, v, s, A, E, r, p, o, n, m, q = F.materialFaceGroup[D],
      x = [],
      z = [],
      w = [],
      C = [],
  ...
  function g() {
    try {
      c = j.getContext("experimental-webgl", {
        antialias: true
      })
    } catch (m) {}
    if (!c) {
